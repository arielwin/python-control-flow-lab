...
def check_voting_eligibility():
    ...
    if user_age < 0:
        print('Take this seriously please.')
    elif user_age < 21:
...
def calculate_dog_years():
    ...
    if age <= 2:
        age = age*10
        print(f"The dog's age is {age} people years.")
    elif age > 2:
        age = 20 + (age-2)*7
        print(f"This is overly complicated and the dog's age is {age} people years")
...
def weather_advice():
    ...
    if cold and raining == 'y':
        print('Wear a waterproof coat.')
    elif cold == 'y' and raining == 'n':
        print('Wear a warm coat.')
    elif cold == 'n' and raining == 'y':
